<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="data" type="text" class="mt-1 data block w-full" wire:model.defer="state.data_nasc" />
            <x-jet-input-error for="data" class="mt-2" />
        </div>
        
        <!-- Endereço -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="endereco" value="{{ __('Endereço Completo') }}" />
            <x-jet-input id="endereco" type="text" class="mt-1 block w-full" wire:model.defer="state.endereco" />

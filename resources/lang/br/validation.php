...
return [
    ...
    */
    ...
    'dimensions' => 'O :attribute tem imagens de dimensões inválidas.',
    ...
    'gt' => [
        ...
        'array' => 'O :attribute deve ter mais que :value items.',
    ],
    'gte' => [
    ...
    'lt' => [
        ...
        'array' => 'O :attribute deve ter menor que :value items.',
    ],
    'lte' => [
    ...
    'max' => [
        ...
        'array' => 'O :attribute não pode ter mais :max items.',
    ],
    ...
    'required_without_all' => 'O campo :attribute é requerido quando nove de :values está presente.',
    'same' => 'O :attribute e :other combina.',
    'size' => [
    ...
    'unique' => 'O :attribute já foi tomadaa.',
    'uploaded' => 'O falha no :attribute ao carregar.',
    'url' => 'O formato :attribute é inválido.',
    'uuid' => 'O :attribute deve ser um válido UUID.',
